...
Every source set that exists will cause Gradle to create several associated configurations as described above.
These configurations should **not** be created or accessed before Gradle does this.
